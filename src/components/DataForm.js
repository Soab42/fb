...
import { booktrip } from "../redux/flightBooking/action";

export default function DataForm() {
  const IsDisabled =
    useSelector((state) => state.flightBooking.trip).length > 2 ? true : false;
  ...
  const addbooking = (e) => {
    ...
    const value = {
      ...
      to: fvalue[1].value,
      date: fvalue[2].value,
      guest: fvalue[3].value,
      trip_class: fvalue[4].value,
    };
    dispatch(booktrip(value));
  };
    ...
    <div>
      <div class="mt-[160px] mx-4 md:mt-[160px] relative">
        <div class="bg-white rounded-md max-w-6xl w-full mx-auto">
          <form class="first-hero lws-inputform" onSubmit={addbooking}>
            {/* <!-- From --> */}
            <div class="des-from">
